...
Key decision: adding extra classes in the FE code to help locating values within card. This alone made it much easier to validate specific results within the cards. 
